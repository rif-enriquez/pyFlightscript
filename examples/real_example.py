...
if __name__ == '__main__':
    ...
    pyfs.fsinit.open_fsm(fsm_filepath=f) # solver is setup already
    ...
    pyfs.fsinit.save_as_fsm(f)
    pyfs.exec_solver.close_flightstream
    # all macro commands done
    pyfs.script.write_to_file() # now write and run the script to script.txt
